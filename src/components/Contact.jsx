        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-y-12 lg:gap-x-8 xl:gap-x-20">
            <div className="flex items-start">
                ...
                <div className="ml-6">
                    ...
                    <p className="mt-4 text-xl font-medium text-gray-900">(316) 555-0116</p>
                </div>
            </div>
            ...
            <div className="flex items-start">
                ...
                <div className="ml-6">
                    ...
                    <p className="mt-4 text-xl font-medium text-gray-900">contact@example.com</p>
                </div>
            </div>
            ...
            <div className="flex items-start">
                ...
                <div className="ml-6">
                    ...
                    <p className="mt-4 text-xl font-medium leading-relaxed text-gray-900"> Chandrapur - 442402, India</p>
                </div>
            </div>
        </div>
    </div>
