...
const Footer = () => {  
    return (
<section className="py-12 bg-gradient-to-r from-gray-600 to-black">
    <div className="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
        <div className="text-center xl:flex xl:items-center xl:justify-between xl:text-left">
            <div className="xl:flex xl:items-center xl:justify-start">
                <div className="w-auto mx-auto h-7 font-extrabold">Logo</div>

                <p className="mt-5 text-sm text-white xl:ml-6 xl:mt-0">© Copyright 2021 Logo</p>
            </div>
