    ...
    <section className="py-10 bg-gray-100 sm:py-16 lg:py-24">
        <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
            <div className="max-w-2xl mx-auto text-center">
                <h2 className="text-3xl font-bold leading-tight text-gray-800 sm:text-4xl lg:text-5xl">Don't just take our  <br/>
                 <span className="text-blue-600">Words</span> for it...</h2>
            </div>
            ...
            <div className="grid max-w-xl grid-cols-1 mx-auto mt-8 text-center lg:max-w-full sm:mt-12 lg:mt-20 lg:grid-cols-3 gap-x-6 xl:gap-x-12 gap-y-6">
                <div className="overflow-hidden bg-white rounded-md shadow">
                    <div className="px-8 py-12">
                        ...
                        <p className="mt-1 text-base text-gray-600">Happy Customer</p>
                    </div>
                </div>
                ...
                <div className="overflow-hidden bg-white rounded-md shadow">
                    <div className="px-8 py-12">
                        ...
                        <p className="text-base font-semibold tex-tblack mt-9">Robert</p>
                        <p className="mt-1 text-base text-gray-600">Food Lover</p>
                    </div>
                </div>
                ...
                <div className="overflow-hidden bg-white rounded-md shadow">
                    <div className="px-8 py-12">
                        ...
                        <p className="text-base font-semibold tex-tblack mt-9">Luis</p>
                        <p className="mt-1 text-base text-gray-600">UI Designer</p>
                    </div>
                </div>
            </div>
        </div>
